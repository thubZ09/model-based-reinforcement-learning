"""
Paper: "Temporal Difference Learning for Model Predictive Control"
Authors: Hansen et al. (2022)
Link: https://arxiv.org/abs/2203.04955

Implicit world model + TD learning + MPC
> No explicit observation reconstruction
> Learns latent dynamics + value together
> Plans with MPPI (Model Predictive Path Integral)
"""
